<template>
    <Grid ref="grid" class="h-[78.4vh] rounded-lg" :data-items="setGridData" :edit-field="'inEdit'" @rowclick="rowClick"
        @cellclick="cellClick" :row-render="rowRender" @itemchange="itemChange" :columns="columns">
